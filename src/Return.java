...
PreparedStatement pst;
    ...
    {
        String sql = "insert into Returnbook(Student_Id,Name,FName,Course,Branch,Year,Semester,Book_Id,BName,Edition,Publisher,Price,Pages,Issuedate,Returndate)"
                + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            pst = conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Return Book", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(255, 51, 51))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon("C:\\Users\\Lonestar\\Documents\\NetBeansProjects\\Library Management System\\images\\SearchnNeww.png")); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Lonestar\\Documents\\NetBeansProjects\\Library Management System\\images\\retrieve.png")); // NOI18N
        ...
        setSize(new java.awt.Dimension(684, 531));
